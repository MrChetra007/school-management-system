...
-- Admin assigns subjects per class in Settings → Classes.
-- Score entry fetches subjects from this table — not global.
-- ============================================================
...
-- Teacher can read subjects for their own class
...
-- Librarian read (needs subject info for book categorization)
